      ...
      <div className='mx-auto max-w-7xl px-8 py-12'>
        <div className='grid grid-cols-1 gap-8 md:grid-cols-4'>
          ...
          <div className='col-span-1'>
            ...
            <p className='text-sm text-gray-400'>
              Discover the beauty of Vietnam with our AI-powered travel assistant and expert guides.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className='space-y-2 text-sm'>
              <li>
                <Link href='/chatbot' className='text-gray-400 hover:text-white'>
                  AI Chatbot
                </Link>
              </li>
              <li>
        ...
        <div className='mt-8 border-t border-gray-800 pt-8'>
          <div className='flex flex-col items-center justify-between gap-4 md:flex-row'>
            <p className='text-sm text-gray-400'>© {new Date().getFullYear()} Vietnam Travel. All rights reserved.</p>
